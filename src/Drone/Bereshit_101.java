...
// https://davidson.weizmann.ac.il/online/askexpert/%D7%90%D7%99%D7%9A-%D7%9E%D7%98%D7%99%D7%A1%D7%99%D7%9D-%D7%97%D7%9C%D7%9C%D7%99%D7%AA-%D7%9C%D7%99%D7%A8%D7%97
	...
	public static void main(String[] args) {
		...
		PID angle_pid = new PID(0.01, 0.0001, 0.05, dt);
		...
		while(alt>0) {
			...
			// lower than 2 km - horizontal speed should be close to zero
				...
				double b = pid.compute(alt);
				if (b>1) {b=1;}
				NN = 1-b;// brake slowly, a proper PID controller here is needed!
				if(hs<2) {hs=0;}
		...
		System.out.println("fuel remain : " + fuel);
		System.out.println("Israel - we have landed!");
	}
}
